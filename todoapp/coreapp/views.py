...
class MainPageView(View):
    ...
    def get(self, request):
        ...
        tasks_list = Task.objects.filter(is_complete=False).order_by("-created_at")
        context = {
            "form": TaskForm(),
...
class EditTaskView(View):
    ...
    def get(self, request, id):
        ...
        tasks_list = Task.objects.filter(is_complete=False).order_by("-created_at").exclude(id=id)
